            ...
            <div className='LeftBar'>
                <div className="offcanvas offcanvas-start custom-width" data-bs-backdrop="true" tabIndex="-1" id="offcanvasLeft" aria-labelledby="offcanvasLeftLabel">
                    ...
                    <div className="offcanvas-body">
                        ...
                        <Link to="/chatInterface" style={{ textDecoration: "none", color: "black" }}>
                            <div className='container leftbar-option my-3'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-chat-left-text-fill" viewBox="0 0 16 16">
                                    <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4.414a1 1 0 0 0-.707.293L.854 15.146A.5.5 0 0 1 0 14.793V2zm3.5 1a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1h-9zm0 2.5a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1h-9zm0 2.5a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1h-5z" />
                                </svg>
                                <span className='mx-2 fs-6 text-center'>Discuss</span>
                            </div>
                        </Link>
                        ...
                        <Link to="/bookmark" style={{ textDecoration: "none", color: "black" }}>
                            <div className='container leftbar-option my-3'>
                                ...
                                <span className='mx-2 fs-6 text-center'>Bookmarks</span>
                            </div>
                        </Link>
